...
def drawgraycircles(surf, circs):
    for _, x, y, r, g in circs:
        pygame.draw.circle(surf, (0,g,0), (x, y), r, 0)
...
#        img = meter(helixmeter(60), 40)
#        img = meter(img, 120)
#        img = pod.giantimgmutagen(zoom = 80)
#        img = spherecircles.img(zoom = 200, R = 0.3, color = (0.8, 0.3, 0.3, 1))
        img = spherecircles.img(zoom = 400, R = 0.6, color = "app0")
#        img = dustcloudimg()
#        img = bulb.img(zoom = 80)
        pass
    if False:
