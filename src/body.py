...
otypes = {
	...
	"bulb": Bulb,
	"star": Star,
	"mutagenpod": MutagenPod,
	"plasterpod": PlasterPod,
	"giantmutagenpod": GiantMutagenPod,
	"giantplasterpod": GiantPlasterPod,
	"mutagenitor": Mutagenitor,
	"plasteritor": Plasteritor,
	"giantmutagenitor": GiantMutagenitor,
	"giantplasteritor": GiantPlasteritor,
	"shield":Shield}